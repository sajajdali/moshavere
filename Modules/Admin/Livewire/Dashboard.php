...
class Dashboard extends Component
{
    ...
    public function mount()
    {
        ...
        $this->fetchData['today_appointment']    = AppointmentUser::today()->DoctorPermittion()->successful()->get()?->count();
    ...
    {
        $permisstionCheck = auth()->user();
        $today_app =  AppointmentUser::today()->DoctorPermittion()->paginate(10);

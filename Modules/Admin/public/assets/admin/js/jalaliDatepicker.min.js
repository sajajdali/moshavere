...
/*!*****************************************************!*\
  !*** ./Resources/assets/js/jalaliDatepicker.min.js ***!
  \*****************************************************/
      ...
      mt = function mt(t) {
        pt(t), function (t) {
          ...
          for (var o = function o(n) {
            ...
            }, a = o({}), r = ot(a.year, a.month), h = it(a.year, a.month, 1), u = 7 * Math.ceil((h + r) / 7) - 1, d = 1 == a.month ? 12 : a.month - 1, c = 12 == a.month ? 1 : a.month + 1, m = 12 == d ? a.year - 1 : a.year, l = 1 == c ? a.year + 1 : a.year, y = 1 == a.month ? ot(a.year - 1, d) : ot(a.year, d), f = it(a.year, a.month, a.day), v = y - f, g = 0, D = function D(e) {

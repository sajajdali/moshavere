...
/*!***********************************************!*\
  !*** ./Resources/assets/js/kamadatepicker.js ***!
  \***********************************************/
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
__webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module './kamadatepicker.scss'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
window.kamaDatepicker = kamaDatepicker;
function kamaDatepicker(elementID, opt) {
  // check arguments
  if (['string', 'object'].indexOf(_typeof(elementID)) === -1 || _typeof(elementID) === 'object' && elementID === null || typeof elementID === 'strinf' && elementID.length === 0) {
    console.error('kamadatepicker error: input ID is not an object, string or is an empty strong!');
    return;
  }
  var options = opt || {};
  ...
  function setCalendarPosition() {
    ...
    var input = inputElement.length === 1 ? inputElement[0] : inputElement;
    ...
    if (options.position === 'top') {
      ...
      if (parentElement.offsetHeight - elementsDistance - (input.offsetHeight + calendarContainer.offsetHeight) > 0) calendarContainer.style.top = "".concat(input.offsetHeight, "px");
      // bottom
      else if (elementsDistance - (input.offsetHeight + calendarContainer.offsetHeight) > 0) calendarContainer.style.top = "".concat(-1 * calendarContainer.offsetHeight, "px");
      // top

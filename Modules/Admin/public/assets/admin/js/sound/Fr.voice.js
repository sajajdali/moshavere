...
/*!***********************************************!*\
  !*** ./Resources/assets/js/sound/Fr.voice.js ***!
  \***********************************************/
/**
.---------------------------------------------------------------------------.
...
(function (window) {
  ...
  Fr.voice = {
     ...
     */
    record: function record(output, finishCallback, recordingCallback) {
     ...
     */
    "export": function _export(callback, type) {
      this.recorder.exportWAV(function (blob) {
        Fr.voice.callExportCallback(blob, callback, type);
      });
    },
    exportMP3: function exportMP3(callback, type) {
     ...
     */
    callExportCallback: function callExportCallback(blob, callback, type) {
     ...
     * @return void
     */
    stopRecordingAfter: function stopRecordingAfter(time, callback) {

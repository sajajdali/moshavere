...
/***/ "./Resources/assets/js/sound/recorder.js":
/*!***********************************************!*\
  !*** ./Resources/assets/js/sound/recorder.js ***!
  \***********************************************/
          ...
          value: function exportMP3(cb) {
            ...
            this.exportWAV(function (blob) {
              ...
              fileReader.onload = function () {
                ...
                encoderWorker.postMessage({
                  cmd: 'encode',
                  buf: $that.Uint8ArrayToFloat32Array(data.samples)
                });
                encoderWorker.postMessage({
                  cmd: 'finish'
                });
                encoderWorker.onmessage = function (e) {
                  if (e.data.cmd === 'data') {
                    currCallback(new Blob([new Uint8Array(e.data.buf)], {
                      type: "audio/mp3"
                    }));
...
/******/ 	var __webpack_exports__ = __webpack_require__("./Resources/assets/js/sound/recorder.js");
/******/ 	
/******/ })()
;
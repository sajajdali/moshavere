...
return [
    ...
    'permission' => [
        [
            'gate' => [
                ...
                'AppointmentSetting.own' => 'دسترسی به تنظیمات حضور خود',
            ],
            'type' => 'light',
    ...
    'menu' => [
        'title' => 'نوبت دهی',
        'gate' => ['appointment_user','appointment_user.own','AppointmentSetting','absence','segment','appointment_user.feedBack','AppointmentSetting.own'],
        'policy_class' => null,
        'has_divider' => true,
        'priority' => 80,

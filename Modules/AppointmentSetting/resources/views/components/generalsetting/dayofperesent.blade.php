 ...
 <div class="col-12 mt-3">
    <div class="main-toggle-group d-sm-flex align-items-center ms-0">
        <div class="toggle toggle-lg toggle-primary my-1 off" wire:ignore.self
            id="saturday" data-bs-toggle="collapse" href="#saturdayTimeCollaps"
...
<div class="col-12 mt-3">
    <div class="main-toggle-group d-sm-flex align-items-center ms-0">
        <div class="toggle toggle-lg toggle-primary my-1 off" wire:ignore.self
            id="sunday" data-bs-toggle="collapse" href="#sundayTimeCollaps"
            role="button" aria-expanded="false" aria-controls="sundayTimeCollaps">
            <span></span>
        </div>
        <div class="ms-2">
    ...
    <div class="card card-body">
        ...
        @for ($i = 0; $i < $counter['sunday']; $i++)
            <div class="row">
                ...
                <div class="col-12 col-md-6"> <label for="input-label"
                        class="form-label">تا
                        ساعت:</label>
...
<div class="col-12 mt-3">
    <div class="main-toggle-group d-sm-flex align-items-center ms-0">
        <div class="toggle toggle-lg toggle-primary my-1 off" wire:ignore.self
            id="monday" data-bs-toggle="collapse" href="#mondayTimeCollaps"
            role="button" aria-expanded="false" aria-controls="mondayTimeCollaps">
            <span></span>
        </div>
        <div class="ms-2">
            ...
            <div>
                ...
                @if ($counter['monday'] > 1)
                    <button type="button" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="حذف کردن بازه ی زمانی"
                        wire:click="removeCounter('monday')"
                        class="btn btn-danger rounded-pill text-center">
...
<div class="col-12 mt-3">
    <div class="main-toggle-group d-sm-flex align-items-center ms-0">
        <div class="toggle toggle-lg toggle-primary my-1 off" wire:ignore.self
            id="tuesday" data-bs-toggle="collapse" href="#tuesdayTimeCollaps"
            role="button" aria-expanded="false" aria-controls="tuesdayTimeCollaps">
            <span></span>
        </div>
        <div class="ms-2">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div>
                ...
                @if ($counter['tuesday'] > 1)
                    <button type="button" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="حذف کردن بازه ی زمانی"
                        wire:click="removeCounter('tuesday')"
                        class="btn btn-danger rounded-pill text-center">
...
<div class="col-12 mt-3">
    <div class="main-toggle-group d-sm-flex align-items-center ms-0">
        <div class="toggle toggle-lg toggle-primary my-1 off" wire:ignore.self
            id="wednesday" data-bs-toggle="collapse" href="#wednesdayTimeCollaps"
            role="button" aria-expanded="false" aria-controls="wednesdayTimeCollaps">
            <span></span>
        </div>
        <div class="ms-2">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div>
                ...
                @if ($counter['wednesday'] > 1)
                    <button type="button" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="حذف کردن بازه ی زمانی"
                        wire:click="removeCounter('wednesday')"
                        class="btn btn-danger rounded-pill text-center">
...
<div class="col-12 mt-3">
    <div class="main-toggle-group d-sm-flex align-items-center ms-0">
        <div class="toggle toggle-lg toggle-primary my-1 off" wire:ignore.self
            id="thursday" data-bs-toggle="collapse" href="#thursdayTimeCollaps"
            role="button" aria-expanded="false" aria-controls="thursdayTimeCollaps">
            <span></span>
        </div>
        <div class="ms-2">
            <p class="text-muted m-0">چهارشنبه</p>
        ...
        <div class="d-flex justify-content-between">
            ...
            <div>
                ...
                @if ($counter['thursday'] > 1)
                    <button type="button" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="حذف کردن بازه ی زمانی"
                        wire:click="removeCounter('thursday')"
                        class="btn btn-danger rounded-pill text-center">
...
<div class="col-12 mt-3">
    <div class="main-toggle-group d-sm-flex align-items-center ms-0">
        <div class="toggle toggle-lg toggle-primary my-1 off" wire:ignore.self
            id="friday" data-bs-toggle="collapse" href="#fridayTimeCollaps"
            role="button" aria-expanded="false" aria-controls="fridayTimeCollaps">
            <span></span>
        </div>
        <div class="ms-2">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div>
                ...
                @if ($counter['friday'] > 1)
                    <button type="button" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="حذف کردن بازه ی زمانی"
                        wire:click="removeCounter('friday')"
                        class="btn btn-danger rounded-pill text-center">

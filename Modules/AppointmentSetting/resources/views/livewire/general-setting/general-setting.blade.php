    ...
    <div class="card @error('form.maxDayAvaialbe') border border-danger @enderror">
        <div class="card-body ">
            ...
            <div class="row">
                ...
                <div class="d-flex  mt-2">
                    <p class="text-muted"><strong class="me-1"> نکته!! </strong> در این قسمت میتوانید تعیین کنید که چند روز فعال را به کاربر نشان بدهد، برای مثال در صورتی که این فیلد را 3 قرار بدهید و شنبه و چهارشنبه را فعال کنید ، سه روز ابتدایی که میتواند شامل یک  شنبه و دو چهارشنبه باشد را به کاربر نشان بدهد. </p>
                </div>
            </div>
        </div>
    </div>

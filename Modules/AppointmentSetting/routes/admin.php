...
use Modules\AppointmentSetting\Livewire\AddAppointment\CreateOrUpdate;
...
Route::group([], function () {
    ...
    //add appointment
    Route::get('appointment/add/{doctorId}/{sectionId}', CreateOrUpdate::class)->name('appointment.add.setTime');

...
class AppointmentUserServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'AppointmentUser';

    protected string $moduleNameLower = 'appointmentuser';

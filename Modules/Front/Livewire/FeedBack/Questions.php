...
class Questions extends Component
{
    ...
    public function mount()
    {
        ...
        if ($appId->kind == AppointmentUserKindEnum::ONLINE) {
            foreach ($this->fetchData['questions'] as $index => $questionEnum) {
                if ($questionEnum['id'] == FeedbackId::QUESTION_3) {
                    unset($this->fetchData['questions'][$index]);
                    break;
                }
            }
        }

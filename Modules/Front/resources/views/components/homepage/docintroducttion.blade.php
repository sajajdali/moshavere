              ...
              <div class="swiper-wrapper">
                @foreach ($fetchData['introductionDoctors'] as $introDoc)
                 <div class="swiper-slide">
                    <article role="banner" class="border-[3px] border-secondary-200 rounded-xl p-5 flex flex-col gap-5">
                       <div class="flex flex-col items-center gap-7">
                          <div class="relative">
                             <span
                                class="absolute top-0 right-0 block w-4 h-4 bg-green border-[3px] border-white rounded-full"></span>
                             <div class="w-[60px] h-[60px] overflow-hidden rounded-full flex items-center justify-center">
                       ...
                       <a href="{{route('front.doctor.profile',['doctor_id' => $introDoc->id])}}" class="btn__blue--tint">دریافت نوبت</a>
                    </article>
                 </div>
                @endforeach
              </div>

<div>
   ...
   <header class="bg-primary-main pt-16 pb-8 space-y-10 md:space-y-16">
    <section class="w-full max-w-[770px] mx-auto px-5 flex flex-col items-center gap-6 md:gap-8">
       ...
       <form wire:submit='searchFor' class="flex items-center p-3 w-full relative bg-white rounded-3xl border-4 md:border-8 border-blue-sky">
          <input type="text" wire:model='form.searchProp' class="text-sm md:text-base flex-grow border-none outline-none pr-7 md:pr-12"

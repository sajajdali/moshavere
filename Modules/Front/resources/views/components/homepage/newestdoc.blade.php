    ...
    <section class="py-12 bg-secondary-100">
        <div class="container space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                @foreach ($fetchData['newestDocs'] as $newDocs)
                    <article role="banner" class="bg-white rounded-xl p-5 flex flex-col gap-5">
                        <div class="flex flex-col items-center gap-7">
                            <div class="relative">
                                ...
                                <div
                                    ...
                                    <img src="{{ $newDocs->getUserAvatar() }}" alt="doctor-image"
                        ...
                        <button wire:click='docpage({{ $newDocs->id }})' class="btn__blue--tint">

                            <div role="status" wire:loading wire:target='docpage({{ $newDocs->id }})'>
                            ...
                            <span wire:loading.remove wire:target='docpage({{ $newDocs->id }})'>دریافت نوبت</span>
                        </button>
                    </article>
                @endforeach

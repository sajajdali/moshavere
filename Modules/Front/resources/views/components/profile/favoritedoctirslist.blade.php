<section class="dashboard__main" id="favoriteDoctorListSection" wire:ignore.self>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="flex flex-col items-center sm:items-end gap-4">
                                <button wire:click='removeFromFavarite("{{ $doctor->id }}")'
                                ...
                                <p class="text-secondary-400 text-sm">شماره نظام پزشکی: {{ $doctor->dr_licence_number }}
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    @else
        <div class="absolute bg-sky-200 border border-sky-200 text-gray-600 px-4 py-3 rounded-lg mt-3" role="alert">
            <strong class="font-bold">نکته!</strong>
            <span class="block sm:inline">هنوز پزشکی به لیست نشان شده های شما اضافه نشده است!.</span>
        </div>
    @endif
</section>

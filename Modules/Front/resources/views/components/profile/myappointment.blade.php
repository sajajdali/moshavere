                            ...
                            <div
                                ...
                                <div class="space-y-3 text-center md:text-right">
                                    <p class="text-lg font-bold">
                                        {{ $appointmentUser->doctor->speciality_type == 1 ? 'دکتر' : '' }}
                                        {{ $appointmentUser->doctor->full_name }}</p>
                                ...
                                <div class="flex flex-col items-end gap-4">
                                    @if ($appointmentUser->isOnline() && $appointmentUser->online->isNotEmpty())
                                        <a href="{{ route('front.user.chatroom', ['onlineAppId' => $appointmentUser->online->first()?->id]) }}"
                            ...
                            @if ($appointmentUser->details[Modules\AppointmentUser\app\Models\AppointmentUser::DETAIL_PAYMENT]['status'])
                                <div
                                    ...
                                    @if (isset($appointmentUser->detail[Modules\AppointmentUser\app\Models\AppointmentUser::DETAIL_PAYMENT]))
                                        <p>{{ number_format($appointmentUser->detail[Modules\AppointmentUser\app\Models\AppointmentUser::DETAIL_PAYMENT][Modules\AppointmentUser\app\Models\AppointmentUser::DETAIL_PAYMENT_PRICE]) }}
                                            تومان</p>
                                    @endif
                                </div>
                            @endif
                            ...
                            <div class="space-y-3 text-sm">
                                ...
                                <main class="flex flex-col gap-3">
                                    <div
                                        ...
                                        @if (isset($appointmentUser->detail[Modules\AppointmentUser\app\Models\AppointmentUser::DETAIL_PAYMENT]))
                                            <p><span
                                                    class="font-bold">{{ number_format($appointmentUser->detail[Modules\AppointmentUser\app\Models\AppointmentUser::DETAIL_PAYMENT][Modules\AppointmentUser\app\Models\AppointmentUser::DETAIL_PAYMENT_PRICE]) }}</span>
                                                تومان</p>
                                        @endif
                                    </div>
                                </main>

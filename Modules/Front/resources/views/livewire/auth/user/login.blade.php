    ...
    <main class="pt-16 bg-secondary-100">
        <form wire:submit='LoginAuthForm' class="bg-white rounded-lg w-full max-w-[600px] mx-auto p-5 flex flex-col gap-4"
            ...
            @if ($step == 1)
                ...
                <input type="text" wire:model='form.mobileNmber'
            ...
            @elseif($step == 2)
                ...
                <input type="text" wire:model='form.code'id="codeInput"
                ...
                <div id="resendCode" style="display: none" wire:ignore.self>
                    <div class="flex items-center justify-center gap-3 text-sm">
                        <div role="status" wire:loading wire:target='resendotpCode'>
                            <svg aria-hidden="true"
                                class="w-5 h-5 text-rose-200 animate-spin dark:text-white-600 fill-lime-700"
                                viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z"
                                    fill="currentColor" />

                    ...
                    <main class="flex flex-col gap-4">
                        ...
                        <button type="button" class="btn__blue--round-full" wire:click='setAppointment'>
                            <span wire:loading wire:target='setAppointment' >
                                <div role="status">
                                    <svg aria-hidden="true" class="w-5 h-5 text-gray-200 animate-spin dark:text-gray-600 fill-blue-700" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">

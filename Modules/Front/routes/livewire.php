...
use Modules\Front\Livewire\Services\Index;
...
Route::middleware(['web'])->group( function () {
    ...
    Route::match(['get','post'],'/appointment/detail/{tracking_code}', AppointmentDetail::class)->name('front.setAppointment.detail');

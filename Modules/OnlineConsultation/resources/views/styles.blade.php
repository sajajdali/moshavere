...
<style>
    ...
    .oc-module .oc-alternate-phones > summary { cursor: pointer; list-style: none; user-select: none; }
    .oc-module .oc-alternate-phones > summary > div { flex: 1 1 auto; }
    .oc-module .oc-alternate-phones > summary > .oc-count-badge { order: 3; flex: 0 0 auto; }
    .oc-module .oc-alternate-phones > summary::-webkit-details-marker { display: none; }
    .oc-module .oc-alternate-phones > summary::after { content: '\f078'; order: 2; flex: 0 0 auto; font-family: "Font Awesome 6 Free"; font-weight: 900; color: var(--oc-muted); transition: transform .2s ease; }
    .oc-module .oc-alternate-phones[open] > summary::after { transform: rotate(180deg); }
    .oc-module .oc-alternate-phone-form { max-width: 620px; padding: 16px; border: 1px solid var(--oc-border); border-radius: 12px; background: #f8fafc; }
    .oc-module .oc-alternate-phone-controls { display: grid; grid-template-columns: minmax(180px, 1fr) auto; gap: 10px; align-items: center; }
    .oc-module .oc-alternate-phone-controls .oc-input { height: 42px; }
    .oc-module .oc-alternate-phone-controls .oc-btn { height: 42px; min-width: 112px; padding: 0 16px; white-space: nowrap; }
    .oc-module .oc-alternate-phone-list { gap: 8px; }
    .oc-module .oc-alternate-phone-row { display: flex; align-items: center; justify-content: space-between; gap: 16px; padding: 12px 14px; border: 1px solid var(--oc-border); border-radius: 10px; background: #fff; }
    .oc-module .oc-alternate-phone-row > div { min-width: 0; }
    .oc-module #alternate-phone-success { margin-top: 10px; padding: 10px 12px; }
    ...
    .oc-module .oc-callback-unavailable{display:flex!important;align-items:center;gap:9px}.oc-module .oc-callback-unavailable .oc-btn{opacity:.58;cursor:not-allowed}.oc-module .oc-callback-unavailable small{max-width:250px;color:#956217;font-size:10.5px;line-height:1.6}
    ...
    .oc-module .oc-consultation-clock{--clock-accent:#2563eb;--clock-accent-2:#06b6d4;position:relative;overflow:hidden;border:1px solid #cfe0f5;border-radius:20px;background:linear-gradient(145deg,#f8fbff 0%,#fff 58%,#f0f9ff 100%);box-shadow:0 18px 45px rgba(30,64,175,.1)}
    .oc-module .oc-clock-glow{position:absolute;inset:-90px auto auto -70px;width:240px;height:240px;border-radius:50%;background:radial-gradient(circle,rgba(37,99,235,.16),transparent 68%);pointer-events:none}.oc-module .oc-clock-head{position:relative;display:flex;align-items:center;justify-content:space-between;gap:16px;padding:20px 22px;border-bottom:1px solid rgba(207,224,245,.75)}
    .oc-module .oc-clock-brand{display:flex;align-items:center;gap:13px}.oc-module .oc-clock-icon{display:grid;place-items:center;width:48px;height:48px;border-radius:15px;background:linear-gradient(135deg,var(--clock-accent),var(--clock-accent-2));color:#fff;font-size:20px;box-shadow:0 9px 22px rgba(37,99,235,.24)}.oc-module .oc-clock-brand small{display:block;color:#64748b;font-size:11.5px}.oc-module .oc-clock-brand h2{margin:3px 0 0;color:#0f172a;font-size:17px;font-weight:800}
    .oc-module .oc-clock-live{display:inline-flex;align-items:center;gap:7px;padding:7px 11px;border:1px solid #bfdbfe;border-radius:20px;background:#eff6ff;color:#1d4ed8;font-size:11px;font-weight:700;white-space:nowrap}.oc-module .oc-clock-live i{width:7px;height:7px;border-radius:50%;background:currentColor;box-shadow:0 0 0 4px rgba(37,99,235,.12)}
    .oc-module .oc-clock-body{position:relative;display:grid;grid-template-columns:minmax(220px,.8fr) minmax(410px,1.2fr);align-items:center;gap:24px;padding:25px 24px}.oc-module .oc-clock-message strong,.oc-module .oc-clock-message span{display:block}.oc-module .oc-clock-message strong{color:#172554;font-size:18px;line-height:1.7}.oc-module .oc-clock-message span{margin-top:5px;color:#64748b;font-size:12px;line-height:1.8}
    .oc-module .oc-countdown{direction:ltr;display:flex;align-items:center;justify-content:flex-end;gap:8px}.oc-module .oc-countdown>div{display:grid;place-items:center;min-width:74px;padding:11px 8px 9px;border:1px solid #dbeafe;border-radius:14px;background:rgba(255,255,255,.9);box-shadow:0 7px 20px rgba(30,64,175,.07)}.oc-module .oc-countdown strong{color:#172554;font-size:25px;font-weight:800;font-variant-numeric:tabular-nums;line-height:1}.oc-module .oc-countdown span{margin-top:6px;color:#64748b;font-size:10px}.oc-module .oc-countdown>b{color:#93c5fd;font-size:20px}
    .oc-module .oc-clock-progress{height:5px;background:#e8f1fb}.oc-module .oc-clock-progress span{display:block;width:0;height:100%;border-radius:5px;background:linear-gradient(90deg,var(--clock-accent),var(--clock-accent-2));transition:width .8s linear}
    .oc-module .oc-clock-times{position:relative;display:grid;grid-template-columns:1fr 35px 1fr;align-items:center;padding:16px 22px;background:rgba(241,247,253,.78)}.oc-module .oc-clock-times>div{display:flex;align-items:center;gap:10px}.oc-module .oc-clock-times>div:last-child{justify-content:flex-end}.oc-module .oc-clock-time-icon{display:grid;place-items:center;width:35px;height:35px;flex:none;border-radius:11px}.oc-module .oc-clock-time-icon.is-start{background:#dcfce7;color:#15803d}.oc-module .oc-clock-time-icon.is-end{background:#fee2e2;color:#b91c1c}.oc-module .oc-clock-times p{margin:0}.oc-module .oc-clock-times small,.oc-module .oc-clock-times strong{display:block}.oc-module .oc-clock-times small{color:#64748b;font-size:10.5px}.oc-module .oc-clock-times strong{margin-top:2px;color:#334155;font-size:12px}.oc-module .oc-clock-route{text-align:center;color:#94a3b8}
    .oc-module .oc-clock-ended{display:flex;align-items:center;justify-content:flex-end;gap:12px}.oc-module .oc-clock-ended>i{display:grid;place-items:center;width:48px;height:48px;border-radius:15px;background:#f1f5f9;color:#64748b;font-size:20px}.oc-module .oc-clock-ended small,.oc-module .oc-clock-ended strong{display:block}.oc-module .oc-clock-ended small{color:#64748b;font-size:11px}.oc-module .oc-clock-ended strong{margin-top:4px;color:#334155;font-size:16px}
    .oc-module .oc-consultation-clock.is-live{--clock-accent:#059669;--clock-accent-2:#22c55e;border-color:#a7f3d0;background:linear-gradient(145deg,#ecfdf5,#fff 62%,#f0fdf4)}.oc-module .oc-consultation-clock.is-live .oc-clock-live{border-color:#a7f3d0;background:#ecfdf5;color:#047857}.oc-module .oc-consultation-clock.is-live .oc-clock-live i{animation:oc-clock-pulse 1.3s infinite}.oc-module .oc-consultation-clock.is-live .oc-clock-message strong,.oc-module .oc-consultation-clock.is-live .oc-countdown strong{color:#064e3b}.oc-module .oc-consultation-clock.is-live .oc-countdown>div{border-color:#bbf7d0}.oc-module .oc-consultation-clock.is-ended{--clock-accent:#64748b;--clock-accent-2:#94a3b8;border-color:#dbe2ea;background:linear-gradient(145deg,#f8fafc,#fff)}.oc-module .oc-consultation-clock.is-ended .oc-clock-live{border-color:#e2e8f0;background:#f1f5f9;color:#64748b}.oc-module .oc-consultation-clock.is-ended .oc-clock-body{grid-template-columns:1fr 1fr}
    @keyframes oc-clock-pulse{0%,100%{box-shadow:0 0 0 4px rgba(5,150,105,.12)}50%{box-shadow:0 0 0 8px rgba(5,150,105,.04)}}
    ...
    @media (max-width: 767px) {
        ...
        .oc-module .oc-follow-up-fields{grid-template-columns:minmax(0,1fr) 95px}.oc-module .oc-note-view{grid-template-columns:1fr;padding:17px 16px;gap:14px}.oc-module .oc-note-author{border-inline-end:0;border-bottom:1px solid #e2e8f0;padding:0 0 14px}.oc-module .oc-appointment-stats .oc-stat{min-height:92px;padding:13px;flex-direction:row;align-items:center;gap:10px}.oc-module .oc-appointment-stats .oc-stat strong{font-size:17px}.oc-module .oc-appointment-stats .oc-stat-detail{white-space:normal}.oc-module .oc-appointment-page .oc-detail-grid>div{padding:13px 15px}.oc-module .oc-clock-head{align-items:flex-start}.oc-module .oc-clock-body{grid-template-columns:1fr;padding:20px 16px}.oc-module .oc-countdown{justify-content:center;gap:4px}.oc-module .oc-countdown>div{min-width:57px;padding-inline:5px}.oc-module .oc-countdown strong{font-size:20px}.oc-module .oc-countdown>b{font-size:16px}.oc-module .oc-clock-times{padding:14px;grid-template-columns:1fr}.oc-module .oc-clock-times>div:last-child{justify-content:flex-start}.oc-module .oc-clock-route{display:none}.oc-module .oc-consultation-clock.is-ended .oc-clock-body{grid-template-columns:1fr}.oc-module .oc-clock-ended{justify-content:flex-start}
    }

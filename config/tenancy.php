...
return [
    ...
    'bootstrappers' => [
        ...
        // Uses key prefixes instead of cache tags, so the file cache remains
        // supported while cache entries stay isolated between tenants.
        App\Tenancy\Bootstrappers\PrefixCacheTenancyBootstrapper::class,

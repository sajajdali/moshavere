...
$(function () {
  ...
  function selectClient(client) {
    ...
    var $client = $('<span><img src="https://cdn.enabz.org/assets/admin/images/users/' + client.element.value.toLowerCase() + '.jpg" class="rounded-circle avatar-sm ms-1" /> ' + client.text + '</span>');
    return $client;
  }
  ;

...
/***/ "./resources/assets/src/js/main.js":
/*!*****************************************!*\
  !*** ./resources/assets/src/js/main.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
// sidebar
var nav_button = document.querySelector('.navbar__menu--button');
var sidebar_container = document.querySelector('.sidebar__container');

// accordion
var accordion__containers = document.querySelectorAll(".accordion__container");
var accordion__containers_2 = document.querySelectorAll(".accordion__container--2");
// tabbar
var tabbar__container_header = document.querySelectorAll('.tabbar__container-header-item');
var tabbar__container_content = document.querySelectorAll('.tabbar__container-content');
...
if (accordion__containers.length) {
  accordion__containers.forEach(function (item, index) {
    var button = item.querySelector(".accordion_select__button");
    button.addEventListener("click", function () {
      document.querySelectorAll(".accordion_select__container").forEach(function (itemContent) {
...
if (accordion__containers_2.length) {
  accordion__containers_2.forEach(function (item, index) {
    ...
    if (!item.classList.contains("open")) {
      item.querySelectorAll(".accordion__container--2.open").forEach(function (nestedItem) {
...
if (tabbar__container_header.length && tabbar__container_content.length) {
  tabbar__container_header.forEach(function (headerItem, headerIndex) {
    headerItem.addEventListener('click', function () {
      tabbar__container_header.forEach(function (item) {
        return item.classList.contains('active') && item.classList.remove('active');
      });
      tabbar__container_content.forEach(function (item) {
        return item.classList.contains('active') && item.classList.remove('active');
      });
...
// ++++++ Swiper cards ++++++
var swiperCards = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-cards', {
...
var swiperCards6 = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-cards-6', {
  modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation],
  slidesPerView: 2,
  spaceBetween: 20,
  breakpoints: {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkversion_4_jangi"] = self["webpackChunkversion_4_jangi"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["css/main"], () => (__webpack_require__("./resources/assets/src/js/main.js")))
/******/ 	__webpack_require__.O(undefined, ["css/main"], () => (__webpack_require__("./resources/assets/src/scss/main.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/main"], () => (__webpack_require__("./node_modules/svg-spritemap-webpack-plugin/svg4everybody-helper.js")))
